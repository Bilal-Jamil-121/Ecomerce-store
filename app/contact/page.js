...
const page = () => {
  return (
    <div className='  bg-white text-black py-10 md:py-10 px-2 md:px-0'>
...
></iframe>
        ...
        <div >
            {/* Contact Form */}
      <form action="https://formspree.io/f/mzzvwekg" method="post" className="max-w-sm  mx-auto my-8 flex flex-col gap-4">
